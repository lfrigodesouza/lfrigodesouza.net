...
<span class="drac-text-black-secondary drac-mb-sm drac-mt-sm">5c80c88b-d1e7-4799-a185-dd8517d1671e</span>
  ...
  return (
    <FooterBar fixed={fixed}>
      <Text as="p" color="purpleCyan">
        ...
        {' '}
        <BeerButton onClick={beerClickHandler}>Buy me a beer</BeerButton>
      </Text>
